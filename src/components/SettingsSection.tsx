        ...
        <div className="bg-white rounded-2xl p-5 border border-stone-200/80 shadow-2xs space-y-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <h3 className="font-bold text-stone-800 text-base">
                  Cài đặt âm thanh chuông thông báo (Trước 10 phút)
                </h3>
                <p className="text-xs text-stone-600">
                  Phát âm thanh chuông êm dịu nhắc nhở trước 10 phút cho lịch học, hạn nộp và sự kiện
                </p>
              </div>
            </div>
          ...
          {soundSettings.enabled ? (
            <div className="space-y-4">
              ...
              <div className="pt-2 border-t border-stone-100 flex flex-wrap items-center justify-between gap-3 text-xs">
                <span className="text-stone-600">
                  Thời gian báo trước: <strong className="text-amber-900 bg-amber-100/70 px-2 py-0.5 rounded border border-amber-300">10 phút (Mặc định)</strong>
                </span>
                <div className="flex items-center gap-3">
            ...
            <p className="text-xs text-stone-500 italic">
              Chuông âm thanh đang tắt. Bạn có thể bật công tắc ở trên để nhận thông báo âm thanh trước 10 phút.
            </p>
          )}
        </div>
      )}
